//setTimeout("addMozimagePanel()", 1000);

function addMozimagePanel() {
	try {
		addPanel('MozImage', "chrome://mozimage/content/mozimage.xul", "");
	} catch (e) {
		alert(e);
	}
...
function launchmozimage_click_mozilla(getLink) {
	addMozimagePanel();
}


///////////////////////////////////////////////////////////////////////////
// These functions have been picked here :
// http://www.mozdev.org/source/browse/blozom/junkie/content/sidebarinstall.js?rev=1.1&content-type=text/x-cvsweb-markup
// It is used to use sidebar in Mozilla as in Firefox.
///////////////////////////////////////////////////////////////////////////
