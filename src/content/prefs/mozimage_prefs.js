...
getHomeDir : 
  function () { return(this.homeDir); },

setHomeDir : 
  function (aValue) { this.homeDir = aValue; },

getListCollapsed : 
  function () { return(this.listCollapsed); },

setListCollapsed : 
  function (aValue) { this.listCollapsed = Boolean(aValue); },

getExtList : 
  function () { return(this.extList); },

setExtList : 
  function (aValue) { this.extList = aValue; },

getAutoSize : 
  function () { return(Boolean(this.autoSize)); },

setAutoSize : 
  function (aValue) { this.autoSize = Boolean(aValue); },

getSlideshow : 
  function () { return(Boolean(this.slideshow)); },

setSlideshow : 
  function (aValue) { this.slideshow = Boolean(aValue); },

getDelay : 
  function () { return(Number(this.delay)); },

setDelay : 
  function (aValue) { this.delay = Number(aValue); },
  
getZoom : 
  function () { return(Number(this.zoom)); },

setZoom : 
  function (aValue) { this.zoom = Number(aValue); },

getThumbSize : 
  function () { return(Number(this.thumbSize)); },

setThumbSize : 
  function (aValue) { this.thumbSize = Number(aValue); },

getOrderBy : 
  function () { return(this.orderBy); },

setOrderBy : 
  function (aValue) { this.orderBy = aValue; },

getDescending : 
  function () { return(Boolean(this.descending)); },

setDescending : 
  function (aValue) { this.descending = Boolean(aValue); },
  
getForceHttpTumb : 
  function () { return(Boolean(this.forceHttpTumb)); },

setForceHttpTumb : 
  function (aValue) { this.forceHttpTumb = Boolean(aValue); },
  
getEnableCache : 
  function () { return(Boolean(this.enableCache)); },

setEnableCache : 
  function (aValue) { this.enableCache = Boolean(aValue); },
  
getEnableCurrent : 
  function () { return(Boolean(this.enableCurrent)); },

setEnableCurrent : 
  function (aValue) { this.enableCurrent = Boolean(aValue);  },  

getMacroName : 
  function () { return(this.macroName); },

setMacroName : 
  function (aValue) { this.macroName = aValue; },

getMacroCode :
  function () { return(this.macroCode); },

setMacroCode : 
  function (aValue) { this.macroCode = aValue; },

getConvertPath : 
  function () { return(this.convertPath); },

setConvertPath : 
  function (aValue) { this.convertPath = aValue; },

getEditorsName:
  function () { return(new Array(this.editorName1, this.editorName2, this.editorName3, this.editorName4)); },
...
getEditorsPath:
  function () { return(new Array(this.editorPath1, this.editorPath2, this.editorPath3, this.editorPath4)); },
